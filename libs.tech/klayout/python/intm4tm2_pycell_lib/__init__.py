...
# Creates the IntM4TM2 technology
from .intm4tm2_tech import *
...
class PyCellLib(pya.Library):
    def __init__(self):
        self.description = "IHP IntM4TM2 interposer Pcells"
        self.technology = 'intm4tm2'

        tech = Tech.get('IntM4TM2')
