...
class cmim(DloGen):
    ...
    def genLayout(self):
        # getGridResolution() returns 0.0 here, exactly as in the
        # IHP-Open-PDK reference implementation; GridFix() therefore works
        # on the 'grid' tech parameter fallback. Kept for parity.
